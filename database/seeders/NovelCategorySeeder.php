    ...
    public function run(): void
    {
        $categories = [
            [
                ...
                'description' => 'นิยายแนวแฟนตาซี จินตนาการ เวทมนตร์ และการผจญภัย',
            ],
            [
                'name' => 'โรแมนติก',
                'slug' => 'romance',
                'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M16.5 3C19.5376 3 22 5.5 22 9C22 16 14.5 20 12 21.5C9.5 20 2 16 2 9C2 5.5 4.5 3 7.5 3C9.35997 3 11 4 12 5C13 4 14.64 3 16.5 3Z"></path></svg>',
                'description' => 'นิยายแนวความรัก โรแมนติก ดราม่า',
            ]
        ];

        foreach ($categories as $category) {
            NovelCategory::create($category);
        }
    }
}
